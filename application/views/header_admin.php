...
<body>
  <nav class="navbar navbar-expand-lg navbar-fixed-top" style="background-color:#303030;">
    <a class="navbar-brand" style="color:white;" href="<?= URL ?>Admin/index"><?= $_SESSION[SESSION_LOGIN]->usu_nome ?></a>
        ...
        <div class="" style="float:left; padding:19.5px 15px; height:60px; margin-left:5vw;">
          <ul class="list-inline">
            ...
            <li>
              <a href="<?= URL ?>Admin/filmes">Filmes</a>
            </li>
            <li>
              <a href="<?= URL ?>Admin/atores">Atores</a>
            </li>
          </ul>
        </div>
