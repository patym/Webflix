...
<div class="col-lg-6">
  <div class="jumbotron text-center" style="margin-top: 1vh;">
    ...
    <form  method="post" action="<?= URL ?>Admin/atores" id="formAtor">
    ...
    <tbody>
      <?php  foreach ($this->resultadoBusca as $ator) {?>
        <tr>
          ...
          <td><button class="btn btn-primary btnImageAtor" value="<?= $ator->image ?>" id="<?= $ator->name ?>"><i class="fa fa-external-link"></i></button></td>
        </tr>
      <?php }?>
    </tbody>
  </table>
